...
This repo contains Ansible Custom Modules and Playbooks developed to help automate the management of user accounts and permissions on a varity of DevOos tools.
